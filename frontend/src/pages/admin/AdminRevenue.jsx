...
import { getRevenueDashboard } from '../../services/ticketService'
...
const AdminRevenue = () => {
    ...
    const fetchRevenue = async () => {
        ...
        setSalaryTotalPages(
            Math.ceil(
                salaryPaginator.count / salaryPaginator.page_size
            )
        );
        ...
        setSubscriptionTotalPages(
            Math.ceil(
                subscriptionPaginator.count /
                subscriptionPaginator.page_size
            )
        );
    };
