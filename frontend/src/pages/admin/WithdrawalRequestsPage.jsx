...
const WithdrawalRequestsPage = () => {
  ...
  return (
    <DashboardLayout title="Financial Operations">
                        ...
                        {item.status === "PENDING" && (
                          <div className="flex items-center justify-end gap-2">
                            <button 
                              ...
                              className="inline-flex items-center justify-center px-3 py-1.5 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100/80 border border-emerald-200 rounded-lg transition-colors shadow-sm"
                            >
                              Approve
                            </button>
                            ...
                            <button 
                              ...
                              className="inline-flex items-center justify-center px-3 py-1.5 text-xs font-bold text-rose-700 bg-rose-50 hover:bg-rose-100/80 border border-rose-200 rounded-lg transition-colors shadow-sm"
                            >
                              Reject
                            </button>
                          </div>
      ...
      {/* SYSTEM CONFIRMATION OVERLAY FOR MANAGEMENT ACTIONS */}
      <ConfirmModal
        isOpen={isModalOpen}
